...
![AXI主设备与从设备之间的通信](./img/5791357-e482ae3da2c20de1.png?raw=true)
...
![AXI Interconnect](./img/5791357-0438441b293eb7f4.png?raw=true)
...
>举例如下：
>
>![地址分配错误](./img/5791357-e165c839d07af771.png?raw=true)
>
...
![时序图样说明图](./img/5791357-91498b498c15fec4.png?raw=true)
...
![VALID before READY Mode](./img/5791357-a0baa31bc5359adf.png?raw=true)
...
![READY before VALID Mode](./img/5791357-73ee6e70e1ff37aa.png?raw=true)
...
![VALID with READY Mode](./img/5791357-004a0da09790f386.png?raw=true)
...
![Burst概念](./img/5791357-963f33ae2721858e.png?raw=true)
...
![Master Interface](./img/5791357-80576aaad0e282a1.png?raw=true)

---------

**从设备接口**

![Slave Interface](./img/5791357-4e3732c995a01f40.png?raw=true)
...
![读通道架构](./img/5791357-6953c0bc92bd8a3b.png?raw=true)

如上图所示，主设备向从设备通过读地址通道指定读数据地址及控制信号，从设备通过读数据通道将指定地址上的数据传输给主设备。

---------

![Read Burst 流程](./img/5791357-75e582738422f57d.png?raw=true)
...
![读操作信号依赖](./img/5791357-8f290b4281cf52e5.png?raw=true)
...
![写通道架构](./img/5791357-3585cfacbdb1e56b.png?raw=true)

如上图所示，主设备向从设备通过写地址通道指定写数据地址及控制信号，从设备通过写数据通道将指定数据写到从设备的指定地址上。待数据写入完成后，从设备通过写响应通道向主设备传递写响应信号，表明写入完成。

---------

![Write Burst 流程](./img/5791357-60e34f3f46b0daea.png?raw=true)
...
![写操作依赖](./img/5791357-1aeca32943659356.png?raw=true)
